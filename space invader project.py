...
# Background
background = pygame.image.load('backgornd.png')
...
for _i in range(num_of_enemies):
    ...
    enemyImg.append(img)
    enemyX.append(random.randint(0, SCREEN_WIDTH - 40))  # 64 is the size of the enemy
...
while running:
    ...
    playerX = max(0, min(playerX, SCREEN_WIDTH - 40))  # 64 is the size of the player
